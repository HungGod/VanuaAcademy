      ...
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-4">
            <a 
              href="https://instagram.com/vanuaacademy" 
              target="_blank" 
            ...
            <a 
              href="https://linkedin.com/vanuaacademy" 
              target="_blank" 
              rel="noopener noreferrer"
              className="text-black hover:text-[#72955f] transition-colors"
              aria-label="LinkedIn"
            ...
            <a 
              href="https://facebook.com/vanuaacademy" 
              target="_blank" 
              rel="noopener noreferrer"
              className="text-black hover:text-[#72955f] transition-colors"
              aria-label="Facebook"
            ...
            <a 
              href="mailto:info@vanuaacademy.com" 
              className="px-4 py-2 text-black border-2 border-[#000000] rounded-lg font-medium transition-colors"
              style={{ backgroundColor: '#ffffff'}}
              onMouseEnter={(e) => e.currentTarget.style.backgroundColor = '#72955f'}
          ...
          <nav className="md:hidden mt-4 pb-4 space-y-3">
            ...
            <div className="flex items-center space-x-4 pt-2">
              ...
              <a 
                ...
                onMouseLeave={(e) => e.currentTarget.style.backgroundColor = '#72955f'}
              >
                Contact Us
              </a>
            </div>

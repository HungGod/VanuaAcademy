          ...
          {qualifications.map((qual, index) => (
            ...
            >
              ...
              <div className="p-6 flex flex-col flex-grow">
                <h3 className="text-xl font-semibold mb-3 text-black min-h-[3rem]">{qual.name}</h3>
                <p className="text-sm text-gray-500 mb-4 flex-grow">{qual.description}</p>
                <p className="text-2xl text-center font-bold text-[#72955f] mt-auto">{qual.price}</p>
              </div>
            </div>
          ))}
        </div>
